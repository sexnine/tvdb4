...
pub struct ListExtendedRecord {
    ...
    #[serde(rename = "imageIsFallback", skip_serializing_if = "Option::is_none")]
    pub image_is_fallback: Option<bool>,
    #[serde(rename = "isOfficial", skip_serializing_if = "Option::is_none")]
...
impl Default for ListExtendedRecord {
    fn default() -> Self {
        Self::new()
    }
}

impl ListExtendedRecord {
    /// extended list record
    pub fn new() -> ListExtendedRecord {
        ListExtendedRecord {
            aliases: None,
            entities: None,
            id: None,
