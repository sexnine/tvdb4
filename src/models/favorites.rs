...
pub struct Favorites {
    ...
    pub series: Option<Vec<i32>>,
    #[serde(rename = "movies", skip_serializing_if = "Option::is_none")]
    pub movies: Option<Vec<i32>>,
