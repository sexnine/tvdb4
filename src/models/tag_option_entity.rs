...
/// TagOptionEntity : a entity with selected tag option

#[derive(Clone, Debug, PartialEq, Serialize, Deserialize)]
pub struct TagOptionEntity {
...
impl Default for TagOptionEntity {
    fn default() -> Self {
        Self::new()
    }
}

impl TagOptionEntity {
    /// a entity with selected tag option
    pub fn new() -> TagOptionEntity {
        TagOptionEntity {
            name: None,
            tag_name: None,
            tag_id: None,
