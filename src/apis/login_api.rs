...
pub async fn login_post(
    ...
    login_post_request: crate::models::LoginPostRequest,
) -> Result<crate::models::LoginPost200Response, Error<LoginPostError>> {
    ...
    if !local_var_status.is_client_error() && !local_var_status.is_server_error() {
        ...
        let local_var_entity: Option<LoginPostError> =
